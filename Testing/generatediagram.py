...
dot.render(folder_path + 'flowchart', format='png')

# Display the generated image
Image('flowchart.png')
similarly provide code for car modelling ,dont forget to import necessary libraries,provide only the code dont include the word python and the symbol ``` in the output''')
